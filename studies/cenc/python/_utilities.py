...
def tic_subprocess( callCommand, verbose_flag=False, debug_flag=False,  nohup_flag=False, wait_flag=True ):
    iw_subprocess( callCommand, verbose_flag, debug_flag,  nohup_flag, wait_flag )
