...
t1w_gm_probtissue=$HFPEF_FMRIPREP_PATH/${subject}/${session}/anat/${subject}_${session}_T1w_space-MNI152NLin2009cAsym_class-GM_probtissue.nii.gz
t1w=$HFPEF_FMRIPREP_PATH/${subject}/${session}/anat/${subject}_${session}_T1w_space-MNI152NLin2009cAsym_preproc.nii.gz
...
ln -f ${t1w} ${netprep_input}/t1w_mni_preproc.nii.gz
