...
24                        27-DTI_30dir_1b0 P>>A        *ep_b0   112   112    60     1  8.500   82.00       False                False
                                       ...
                                       series_id sequence_name   dim1  dim2  dim3  dim4     TR      TE  is_derived  is_motion_corrected
0                   2-pcasl_wfu_4_0C 3min highCO2   epfid2d1_64     64    64    28   107  4.000   12.00       False                False
1                   3-pcasl_wfu_4_0C 3min highCO2   epfid2d1_64     64    64    28     1  4.000   12.00        True                False
2                 4-pcasl_wfu_4_0C R>>L EYES OPEN   epfid2d1_56     70    56    43    81  4.000   11.00       False                False
3                 5-pcasl_wfu_4_0C R>>L EYES OPEN   epfid2d1_56     70    56    43     1  4.000   11.00        True                False
4   6-pcasl_wfu_4_0C L>>R (COPY SLICES FROM R>>L)   epfid2d1_56     70    56    43     3  4.000   11.00       False                False
5   7-pcasl_wfu_4_0C L>>R (COPY SLICES FROM R>>L)   epfid2d1_56     70    56    43     1  4.000   11.00        True                False
6                                8-MPRAGE_GRAPPA2  *tfl3d1_16ns    256   240   192     1  2.300    2.98       False                False
7                          9-mbep2d_bold 3mm L>>R   epfid2d1_64     72    64    64    10  0.570   30.00       False                False
8                         10-mbep2d_bold 3mm L>>R   epfid2d1_64     72    64    64    10  0.570   30.00       False                 True
9   11-mbep2d_bold 3mm R>>L (copy from bold L>>R)   epfid2d1_64     72    64    64   500  0.570   30.00       False                False
10  12-mbep2d_bold 3mm R>>L (copy from bold L>>R)   epfid2d1_64     72    64    64   500  0.570   30.00       False                 True
11                          13-T2 FLAIR SPACE NEW  *spcir_192ns    256   236   192     1  5.000  383.00       False                False
12                     14-BOLD_resting 4X4X4 A>>P  *epfid2d1_64     64    64    35   190  2.000   25.00       False                False
13                             15-rest_topup_A>>P   *epse2d1_64     64    64   140     1  2.000   25.00       False                False
14                             16-rest_topup_P>>A   *epse2d1_64     64    64   140     1  2.000   25.00       False                False
15                    17-Field_mapping 4X4X4 A>>P       *fm2d2r     64    64    35     1  0.488    4.92       False                False
16                    18-Field_mapping 4X4X4 A>>P       *fm2d2r     64    64    35     1  0.488    7.38       False                False
17                          19-DTI_30dir_1b0 A>>P        *ep_b0    112   112    60    31  8.500   82.00       False                False
18                          20-DTI_30dir_1b0 A>>P   *ep_b0_1000    112   112    60     1  8.500   82.00        True                False
19                          21-DTI_30dir_1b0 A>>P    *ep_b1000t    112   112    60     1  8.500   82.00        True                False
20                          22-DTI_30dir_1b0 A>>P   *ep_b0_1000    112   112    60     1  8.500   82.00        True                False
21                          23-DTI_30dir_1b0 A>>P     Not found    112   112    60     1 -1.000   -1.00        True                False
22                          25-DTI_30dir_1b0 P>>A        *ep_b0    112   112    60     1  8.500   82.00       False                False
...
#                                )
    ...
    sequences['rest_topup'] = criteria(key='sub-{subject}/{session}/func/sub-{subject}_{session}_task-rest_acq-epi_rec-topup_bold.{item:01d}',
    ...
    sequences['rest_fmap'] = criteria(key='sub-{subject}/{session}/func/sub-{subject}_{session}_task-rest_acq-epi_rec-fmap_bold.{item:01d}',
                                series_description='BOLD_resting',
                                sequence_name='epfid2d1_64',
                                dim4=[190,190]
                                )
    ...
    sequences['pcasl_lr_high_co2'] = criteria(key='sub-{subject}/{session}/func/sub-{subject}_{session}_task-rest_acq-pcasl_bold.{item:01d}',
                                series_description='pcasl_wfu_4_0C 3min highCO2',
                                sequence_name='epfid2d1_56',
                                dim4=[107,107],
                                is_derived=False
                                )
    sequences['pcasl_rl_rest'] = criteria(key='sub-{subject}/{session}/fmap/sub-{subject}_{session}_acq-pcasl_dir-rl_epi.{item:01d}',
                                series_description='pcasl_wfu_4_0C R>>L',
                                sequence_name='epfid2d1_56',
                                dim4=[81,81],
                                is_derived=False
                                )
    ...
    sequences['pcasl_topup_lr'] = criteria(key='sub-{subject}/{session}/fmap/sub-{subject}_{session}_acq-pcasl_dir-lr_epi.{item:01d}',
                                series_description='pcasl_wfu_4_0C L>>R',
                                sequence_name='epfid2d1_56',
                                dim4=[3,3],
                                is_derived=False
                                )
