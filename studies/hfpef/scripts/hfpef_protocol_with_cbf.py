...
"""
    ...
    List images collected and stored as DICOM files
    -------------------------------------------------------------------------------------------------
                                     series_id sequence_name                        series_description  dim1  dim2  dim3  dim4     TR      TE  is_derived  is_motion_corrected
0                              2-MPRAGE_GRAPPA2  *tfl3d1_16ns                            MPRAGE_GRAPPA2   256   240   192     1  2.300    2.98       False                False
1                        3-mbep2d_bold 3mm L>>R   epfid2d1_64                mbep2d_bold 3mm L>>R_SBRef    72    64    64     1  0.570   30.00       False                False
2                        4-mbep2d_bold 3mm L>>R   epfid2d1_64                      mbep2d_bold 3mm L>>R    72    64    64    10  0.570   30.00       False                False
3                        5-mbep2d_bold 3mm R>>L   epfid2d1_64                mbep2d_bold 3mm R>>L_SBRef    72    64    64     1  0.570   30.00       False                False
4                        6-mbep2d_bold 3mm R>>L   epfid2d1_64                      mbep2d_bold 3mm R>>L    72    64    64   500  0.570   30.00       False                False
5                          7-T2 FLAIR SPACE NEW  *spcir_192ns                        T2 FLAIR SPACE NEW   256   236   192     1  5.000  395.00       False                False
6                     8-BOLD_resting 4X4X4 A>>P  *epfid2d1_64                   BOLD_resting 4X4X4 A>>P    64    64    35   190  2.000   25.00       False                False
7                             9-rest_topup_A>>P   *epse2d1_64                           rest_topup_A>>P    64    64   140     1  2.000   25.00       False                False
8                            10-rest_topup_P>>A   *epse2d1_64                           rest_topup_P>>A    64    64   140     1  2.000   25.00       False                False
9                   11-Field_mapping 4X4X4 A>>P       *fm2d2r                  Field_mapping 4X4X4 A>>P    64    64    35     1  0.488    4.92       False                False
10                  12-Field_mapping 4X4X4 A>>P       *fm2d2r                  Field_mapping 4X4X4 A>>P    64    64    35     1  0.488    7.38       False                False
11              13-pcasl_wfu_3_1 R>>L EYES OPEN   epfid2d1_56              pcasl_wfu_3_1 R>>L EYES OPEN    70    56    43    81  4.000   11.00       False                False
12              14-pcasl_wfu_3_1 R>>L EYES OPEN   epfid2d1_56                                MoCoSeries    70    56    43    81  4.000   11.00        True                 True
13              15-pcasl_wfu_3_1 R>>L EYES OPEN   epfid2d1_56                        Perfusion_Weighted    70    56    43     1  4.000   11.00        True                 True
14              16-pcasl_wfu_3_1 R>>L EYES OPEN   epfid2d1_56                                    relCBF    70    56    43     1  4.000   11.00        True                 True
15  17-pcasl_wfu_3_1 L>>R (COPY SLICES FROM R>L   epfid2d1_56  pcasl_wfu_3_1 L>>R (COPY SLICES FROM R>L    70    56    43     3  4.000   11.00       False                False
16  18-pcasl_wfu_3_1 L>>R (COPY SLICES FROM R>L   epfid2d1_56                                MoCoSeries    70    56    43     3  4.000   11.00        True                 True
17  19-pcasl_wfu_3_1 L>>R (COPY SLICES FROM R>L   epfid2d1_56                        Perfusion_Weighted    70    56    43     1  4.000   11.00        True                 True
18  20-pcasl_wfu_3_1 L>>R (COPY SLICES FROM R>L   epfid2d1_56                                    relCBF    70    56    43     1  4.000   11.00        True                 True
19                        21-DTI_30dir_1b0 A>>P        *ep_b0                        DTI_30dir_1b0 A>>P   112   112    60    31  8.500   82.00       False                False
20                        22-DTI_30dir_1b0 A>>P   *ep_b0_1000                    DTI_30dir_1b0 A>>P_ADC   112   112    60     1  8.500   82.00        True                False
21                        23-DTI_30dir_1b0 A>>P    *ep_b1000t                 DTI_30dir_1b0 A>>P_TRACEW   112   112    60     1  8.500   82.00        True                False
22                        24-DTI_30dir_1b0 A>>P   *ep_b0_1000                     DTI_30dir_1b0 A>>P_FA   112   112    60     1  8.500   82.00        True                False
23                        25-DTI_30dir_1b0 A>>P     Not found                  DTI_30dir_1b0 A>>P_ColFA   112   112    60     1 -1.000   -1.00        True                False
24                        27-DTI_30dir_1b0 P>>A        *ep_b0                        DTI_30dir_1b0 P>>A   112   112    60     1  8.500   82.00       False                False
...
#                                )
    ...
    sequences['pcasl_rl'] = criteria(key='sub-{subject}/{session}/func/sub-{subject}_{session}_task-rest_acq-pcasl_bold.{item:01d}',
                                series_id='pcasl_wfu_3_1 R>>L',
                                sequence_name='epfid2d1_56',
                                dim4=[81,81],
                                is_derived=False
                                )
#
#    Reconstruction on scanner is not correct.  Therefore, there is no reason to convert these images. 
#
#    sequences['pcasl_rl_pwi'] = criteria(key='sub-{subject}/{session}/pwi/sub-{subject}_{session}_task-rest_acq-pwi_bold.{item:01d}',
#                                series_id='pcasl_wfu_3_1 R>>L',
#                                series_description='Perfusion_Weighted',
#                                sequence_name='epfid2d1_56',
#                                dim4=[1,1],
#                                is_derived=True
#                                )
#
#    sequences['pcasl_rl_relcbf'] = criteria(key='sub-{subject}/{session}/pwi/sub-{subject}_{session}_task-rest_acq-relcbf_bold.{item:01d}',
#                                series_id='pcasl_wfu_3_1 R>>L',
#                                series_description='relCBF',
#                                sequence_name='epfid2d1_56',
#                                dim4=[1,1],
#                                is_derived=True
#                                )
...
#              series_id sequence_name                        series_description  dim1  dim2  dim3  dim4     TR      TE  is_derived  is_motion_corrected
#  22-DTI_30dir_1b0 A>>P   *ep_b0_1000                    DTI_30dir_1b0 A>>P_ADC   112   112    60     1  8.500   82.00        True                False
#  23-DTI_30dir_1b0 A>>P    *ep_b1000t                 DTI_30dir_1b0 A>>P_TRACEW   112   112    60     1  8.500   82.00        True                False
#  24-DTI_30dir_1b0 A>>P   *ep_b0_1000                     DTI_30dir_1b0 A>>P_FA   112   112    60     1  8.500   82.00        True                False

    sequences['dti_30dir_ap_adc'] = criteria(key='sub-{subject}/{session}/dwi/sub-{subject}_{session}_acq-adc_dwi.{item:01d}',
                                series_id='DTI_30dir',
    ...
    sequences['dti_30dir_ap_tracew'] = criteria(key='sub-{subject}/{session}/dwi/sub-{subject}_{session}_acq-tracew_dwi.{item:01d}',
                                series_id='DTI_30dir',
                                series_description='TRACEW',
                                dim4=[1,1],
                                is_derived=True
                                )

    sequences['dti_30dir_ap_fa'] = criteria(key='sub-{subject}/{session}/dwi/sub-{subject}_{session}_acq-fa_dwi.{item:01d}',
                                series_id='DTI_30dir',
                                series_description='_FA',
                                dim4=[1,1],
                                is_derived=True
                                )
