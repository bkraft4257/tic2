...
alias inf_hdc='/gandg/infinite/imaging_data/scripts/inf_hdc.sh'

alias inf_fmriprep='/gandg/infinite/imaging_data/scripts/inf_fmriprep.sh'

alias inf_mriqc='/gandg/infinite/imaging_data/scripts/inf_mriqc.sh'
alias inf_mriqc_group='mriqc  $INFINITE_BIDS_PATH $INFINITE_MRIQC_PATH group'

alias inf_prepare_netprep='/gandg/infinite/imaging_data/scripts/prepare_netprep_inf.sh'
alias inf_netprep_gi='/gandg/infinite/imaging_data/scripts/prepare_netprep_inf.sh'
